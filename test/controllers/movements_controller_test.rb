...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { location_id: @movement.location_id, notes: @movement.notes, person_id: @movement.person_id }
    end
  ...
  test "should update movement" do
    patch :update, id: @movement, movement: { location_id: @movement.location_id, notes: @movement.notes, person_id: @movement.person_id }
    assert_redirected_to movement_path(assigns(:movement))
  end
